export const validate = (input) => {
    ...
    else if (!/^[A-Za-z]+$/.test(input.name)) err.name = "Only letters allowed" ; 
    ...
    else if (!/^[0-9]+$/.test(input.minHeight)) err.minHeight = "Only numbers allowed" ;
    ...
    else if (!/^[0-9]+$/.test(input.maxHeight)) err.maxHeight = "Only numbers allowed" ;
    ...
    else if (!/^[0-9]+$/.test(input.minWeight)) err.minWeight = "Only numbers allowed" ;
    ...
    else if (!/^[0-9]+$/.test(input.maxWeight)) err.maxWeight = "Only numbers allowed" ;
    ...
    else if (!/^[0-9]+$/.test(input.minLifeSpan)) err.minLifeSpan = "Only numbers allowed" ;
    ...
    else if (!/^[0-9]+$/.test(input.maxLifeSpan)) err.maxLifeSpan = "Only numbers allowed" ;
